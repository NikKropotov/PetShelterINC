!function (o) {
    var a = function (a) {
        o(a.modalForm).on("submit", function (o) {
            if (void 0 !== o.originalEvent && !1 === a.isDeleteForm) return o.preventDefault(), n(a, t), !1
        ...
        o.ajax({
            ...
            success: function (e) {
                o(e).find(n.errorClass).length > 0 ? (o(n.modalID).find(n.modalContent).html(e), o(n.modalForm).attr("action", n.formURL), a(n)) : t(n)
            }
        })
    }, t = function (n) {
        if (n.asyncUpdate) {
            if (e(n.asyncSettings)) {
                var t = n.asyncSettings, s = new FormData(o(n.modalForm)[0]);
                s.append("asyncUpdate", "True"), o.ajax({
                    type: o(n.modalForm).attr("method"),
                    url: o(n.modalForm).attr("action"),
                    data: s,
                    contentType: !1,
                    ...
                    success: function (e) {
                        var s = o("body");
                        0 === s.length && console.error("django-bootstrap-modal-forms: <body> element missing in your html."), s.prepend(t.successMessage), o.ajax({
                            type: "GET",
                            url: t.dataUrl,
                            dataType: "json",
                            success: function (e) {
                                o(t.dataElementId).html(e[t.dataKey]), t.addModalFormFunction && t.addModalFormFunction(), t.closeOnSubmit ? o(n.modalID).modal("hide") : o(n.modalID).find(n.modalContent).load(n.formURL, function () {
