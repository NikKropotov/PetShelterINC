!function (a, b) {
    ...
    return function (c) {
        ...
        this.options = c || {}, this.elements = [], a(this.options), this.isTouchDevice = function () {
            ...
            for (null === document.head.querySelector("style.anchorjs") && ((f = document.createElement("style")).className = "anchorjs", f.appendChild(document.createTextNode("")), void 0 === (k = document.head.querySelector('[rel="stylesheet"],style')) ? document.head.appendChild(f) : document.head.insertBefore(f, k), f.sheet.insertRule(".anchorjs-link{opacity:0;text-decoration:none;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}", f.sheet.cssRules.length), f.sheet.insertRule(":hover>.anchorjs-link,.anchorjs-link:focus{opacity:1}", f.sheet.cssRules.length), f.sheet.insertRule("[data-anchorjs-icon]::after{content:attr(data-anchorjs-icon)}", f.sheet.cssRules.length), f.sheet.insertRule('@font-face{font-family:anchorjs-icons;src:url(data:n/a;base64,) format("truetype")}', f.sheet.cssRules.length)), f = document.querySelectorAll("[id]"), o = [].map.call(f, function (a) {
                return a.id
            }), c = 0; c < e.length; c++) if (this.hasAnchorJSLink(e[c])) l.push(c); else {
                if (e[c].hasAttribute("id")) h = e[c].getAttribute("id"); else if (e[c].hasAttribute("data-anchor-id")) h = e[c].getAttribute("data-anchor-id"); else {
    ...
    return c = {
        134: function (p, a, b) {
            ...
            i = function () {
                ...
                return b = a, (c = [{
                    ...
                    key: "selectFake", value: function () {
                        var b = this, a = this.createFakeElement();
                ...
                return b = a, d = [{
                    key: "isSupported", value: function () {
                        var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : ["copy", "cut"],
                            a = "string" == typeof a ? [a] : a, b = !!document.queryCommandSupported;
            ...
            a.prototype = {
                on: function (a, c, d) {
                    ...
                    if (a && d) for (b = 0, g = a.length; b < g; b++) a[b].fn !== d && a[b].fn._ !== d && f.push(a[b]);
        ...
        for (var b in c) a.o(c, b) && !a.o(d, b) && Object.defineProperty(d, b, {enumerable: !0, get: c[b]})
    }, a.o = function (a, b) {
    ...
    document.querySelectorAll('.tooltip-demo').forEach(function (a) {
        new bootstrap.Tooltip(a, {selector: '[data-bs-toggle="tooltip"]'})
        ...
        var d = c.relatedTarget, a = d.getAttribute('data-bs-whatever'), e = b.querySelector('.modal-title'),
        ...
        var b = /mac/i.test(navigator.userAgent) ? '\u2318' : 'Ctrl-', c = 'Press ' + b + 'C to copy',
    ...
    }), anchors.options = {icon: '#'}, anchors.add('.bd-content > h2, .bd-content > h3, .bd-content > h4, .bd-content > h5')
}(), function () {
    'use strict';
    var a = document.getElementById('search-input'), b;
    ...
    b = a.getAttribute('data-bd-docs-version'), document.addEventListener('keydown', function (b) {
        ...
        algoliaOptions: {facetFilters: ['version:' + b]},
